...
initial_values = {
    ...
    'initial_food_sites': 4,
    'initial_predator_count': 16,
    'initial_prey_count': 64
}
...
params = {
    ...
    'agent_lifespan': [50],
    'reproduction_food_threshold': [8],  # When the agents start reproducing
    'hunger_threshold': [20],  # When the agents start eating
    'reproduction_food': [2]  # How much food is needed for reproducing
}
